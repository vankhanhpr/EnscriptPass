    ...
    if (data.success && data.data) {
        ...
        for (var i in data.data) {
            ...
            $("#main-form-item").append('<div class="k row-table item-form-detail">' +
                ...
                '<i class="fa fa-cogs" data-toggle="modal"title="Chỉnh sửa" data-target="#modalupdateform"onclick="getFormById(' + item.formid + ')"></i>' +
                '<i class="fa fa-trash-o"title="Xóa" aria-hidden="true"onclick="deleteForm(' + item.formid + ')"></i>' +
                '</div>' +
                '</div>');
        }
    }
