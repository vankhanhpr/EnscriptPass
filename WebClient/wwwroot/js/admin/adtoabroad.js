    ...
    if (data.success && data.data) {
        ...
        for (var i in data.data) {
            ...
            $("#form-item-abroad").append('<div class="k row-table tab-gotoabroad">' +
                ...
                '<i class="fa fa-cogs" data-toggle="modal"title="Cập nhật" data-target="#modalupdateabroad" onclick="getAbroadById(' + item.brid + ')"></i>' +
                '<i class="fa fa-trash-o" aria-hidden="true" title="Xóa" onclick="deleteAbroad(' + item.brid + ')"></i>' +
                '</div>' +
                '</div>');
        }
    }
