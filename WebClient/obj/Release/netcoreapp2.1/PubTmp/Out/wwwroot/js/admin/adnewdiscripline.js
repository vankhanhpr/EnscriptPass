                ...
                $("#form-body-dis").append(`
                    <div class="k row-item main-row-item">
                        ...
                        <span class="k t text-item small-item">
                            <i class="fa fa-trash-o ic-font" onclick="confirm(`+ item.dsid + `)" aria-hidden="true"></i>
                            <i class="fa fa-pencil-square-o ic-font" onclick="getDisciptionById(`+ item.dsid + `)" data-toggle="modal" data-target="#modalupdatedesciption"></i>
                            <i class="fa fa-check-circle-o ic-font" onclick="acceptDis(`+ item.dsid + `,this)"  style ="color:` + (item.accept == true ? '#333333' : 'green') +`" aria-hidden="true"></i>
                        </span>
                    </div>`);
            }
