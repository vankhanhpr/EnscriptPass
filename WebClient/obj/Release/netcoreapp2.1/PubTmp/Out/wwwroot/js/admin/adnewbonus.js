            ...
            $("#form-body-bonus").append(`
                    <div class="k row-item main-row-item">
                        ...
                        <span class="k t text-item small-item">
                            <i class="fa fa-trash-o ic-font"onclick="confirmDeleteBonus(`+ item.bnid + `)" aria-hidden="true"></i>
                            <i class="fa fa-pencil-square-o ic-font" onclick="getBonusById(`+ item.bnid + `)" data-toggle="modal" data-target="#modalupdatebonus"></i>
                            <i class="fa fa-check-circle-o ic-font" onclick="acceptBomus(`+ item.bnid + `,this)"  style ="color:` + (item.accept == true ? '#333333' : 'green') +`" aria-hidden="true"></i>
                        </span>
                    </div>`);
        }
