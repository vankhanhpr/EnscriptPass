            ...
            for (var i in data.data) {
                ...
                $('#form-item-abroad').append(`<div class="k row-item item-toabroad">
                                    ...
                                    <span class="k t text-item small-item">
                                        <i class="fa fa-trash-o ic-font" onclick="confirmDelete(`+ item.brid + `)" aria-hidden="true"></i>
                                        <i class="fa fa-pencil-square-o ic-font" onclick="getAbroadById(`+ item.brid + `)" data-toggle="modal" data-target="#modalupdateabroad"></i>
                                        <i class="fa fa-check-circle-o ic-font" onclick="acceptAbroad(`+ item.brid + `,this)"  style ="color:` + (item.accept == false ? '#333333' : 'green') +`" aria-hidden="true"></i>
                                    </span>
                                   </div>`);
            }
